...
# https://github.com/huggingface/transformers/blob/master/src/transformers/models/megatron_bert/convert_megatron_bert_checkpoint.py
...
def convert_megatron_checkpoint(args, input_state_dict, config):
    ...
    for key, val in transformer.items():
        ...
        # Transpose the bias.
        elif op_name == "self_attention.query_key_value" and weight_or_bias == "bias":
        ...
        # Copy weights and biases as is.
            ...
            # out_name = megatron_to_transformers[op_name] if op_name in megatron_to_transformers else op_name
